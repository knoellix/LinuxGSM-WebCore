...
#   lgsm/
#     config-default/
#       _default.cfg          (port=25565, gamename=Minecraft)
#     config-lgsm/
#       common.cfg            (port=9999)

# Test 1-3: Nur config-default vorhanden -> _has_user_config = 0
{
...
# Test 4-6: config-lgsm/common.cfg überschreibt default
{
    my $dir = tempdir(CLEANUP => 1);
    mkdir "$dir/lgsm";
    mkdir "$dir/lgsm/config-default";
